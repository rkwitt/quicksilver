...
rNoiseSimgaGlobal   = 20;
rNoiseSigmaLocal    = 3.0;
...
%
% compute the inner, middle, and outer radii
r = tToRadiiPixelsa(t',imageDims);
...
tSample = t(iSample);
rSample = r(iSample,:);
rSample = rSample + rNoiseSigmaLocal * randn(size(rSample));

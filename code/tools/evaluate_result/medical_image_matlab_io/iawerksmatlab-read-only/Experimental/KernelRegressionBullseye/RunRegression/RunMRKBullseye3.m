function RunMRKBullseye3(partID, maxJobs, outFilePrefix)
...
ldmmOptParams.maxIterations = 0;       % 20/30
ldmmOptParams.numTimesteps  = 2;       % 10
...
ldmmWriteParams.writeImages      = true;

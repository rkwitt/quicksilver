function [Ihat, Ivar, VarLog, v] = fldmm2D(I, K, v, optParams, fluidParams, writeParams)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
fprintf(stderr,'v');
if size(v) ~= [numDim Dim optParams.numTimesteps M]
  fprintf(stderr,'v is initialized to zero\n');
  v = zeros([numDim Dim optParams.numTimesteps M],dtype);
else
  fprintf(stderr,'v was initialized by user\n');
end

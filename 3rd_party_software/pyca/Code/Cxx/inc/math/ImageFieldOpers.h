...
#ifndef __IMAGE_FIELD_OPER_H
#define __IMAGE_FIELD_OPER_H
...
template<int mode>
class ImageFieldOpers{
public:
    enum { exec_mode = mode };
    typedef typename BinSelector<mode, CImageFieldOpers, GImageFieldOpers>::Result Executer;
 ...
 */
   ...
   // used for applying Splat to components of vector field
 ...
 *  d_o = grad (a_i)
 */
   static void Gradient(Field3D& a_o, const float* a_i, 
 ...
 */
   ...
   static void GradFor(Field3D& a_o, const Image3D& a_i, 
    ...
    static void GradForMag(Image3D& a_o, const Image3D& a_i, StreamT s);
    ...
    */
   static void UpwindGradMag(Image3D& a_o, const Image3D& a_i,
...
/** @brief a_o = a_o + a_i * a_i1 * c */
    ...
    static void JacDetH(Image3D& a_detJ,const Field3D& a_Xg, const Field3D& a_Yg, const Field3D& a_Zg, StreamT s);

    static void JacDetV(Image3D& a_detJ,const Field3D& a_Xg, const Field3D& a_Yg, const Field3D& a_Zg, StreamT s);

    static void JacDetVInv(Image3D& a_detJ,const Field3D& a_Xg,const Field3D& a_Yg,const Field3D& a_Zg,StreamT s);

    static void JacDetH(Image3D& a_detH, const Field3D& a_h, 
			DiffT diffType=DIFF_CENTRAL, BoundaryCondT bc=BC_APPROX, 
			StreamT s=NULL);
